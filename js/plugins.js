...
(function($) {
	...
	$("#facts").appear(function() {
		$("#number_1").animateNumber({
			number: 853	// Change to your number			
		}, 2200);
		...
		$("#number_4").animateNumber({
			number: 9		// Change to your number
		}, 2200);
	}, {
		accX: 0,
		accY: -150
...
function init() {
	...
	var mapOptions = {
		...
		center: new google.maps.LatLng(23.779502, 90.421590),	// Change to your latitude & longitude
	...
	var marker = new google.maps.Marker({
		position: new google.maps.LatLng(23.779502, 90.421590),	// Change to your latitude & longitude
